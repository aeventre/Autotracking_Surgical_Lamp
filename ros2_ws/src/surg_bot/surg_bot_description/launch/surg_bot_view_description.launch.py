...
def generate_launch_description():
    ...
    rviz_config_filename = 'surg_bot_description_view.rviz'
    ...
    urdf_model = '/home/alec/Autotracking_Surgical_Lamp/ros2_ws/src/surg_bot/surg_bot_description/urdf/surg_bot_description.urdf'
    ...
    robot_description_content = ParameterValue(Command([urdf_model]), value_type=str)
